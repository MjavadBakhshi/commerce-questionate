import { EN_OTHER_OPTION } from "@/lib/survey/locales/en/copy";
import type { SurveyQuestion, SurveySection } from "@/types/survey";

export { EN_OTHER_OPTION as OTHER_OPTION };

export const EN_SECTIONS: SurveySection[] = [
  {
    id: "business-info",
    number: 1,
...
export const EN_QUESTIONS: SurveyQuestion[] = [
  q({
    id: "q1",
    number: 1,
